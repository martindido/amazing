...
(function() {
  ...
  Maze.Algorithms.Eller = (function(_super) {
    __extends(Eller, _super);
    ...
    Eller.prototype.horizontalStep = function() {
      ...
      if (this.column + 1 >= this.maze.width) {
        ...
        if (this.isFinal()) {
          this.pending = false;
          _ref = [this.column, null], oldColumn = _ref[0], this.column = _ref[1];
    ...
    Eller.prototype.verticalStep = function() {
      ...
      if (this.verticals.length === 0) {
        ...
        _ref = [this.column, this.verticals.pop()], oldColumn = _ref[0], this.column = _ref[1];
  ...
  Maze.Algorithms.Eller.State = (function() {
    ...
    State.prototype.populate = function() {
      ...
      while (cell < this.width) {
        if (!this.cells[cell]) {
          set = (this.counter += 1);
          ((_base = this.sets)[set] != null ? _base[set] : _base[set] = []).push(cell);
          this.cells[cell] = set;
        }
        cell += 1;
      }
    ...
    State.prototype.foreach = function(fn) {
      var id, set, _ref, _results;
      _ref = this.sets;
      _results = [];
      for (id in _ref) {
        set = _ref[id];
        _results.push(fn(id, set));
      }
      return _results;
    };
